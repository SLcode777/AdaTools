...
/**
  ...
  /**
   * `prisma.domainName`: Exposes CRUD operations for the **DomainName** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more DomainNames
    * const domainNames = await prisma.domainName.findMany()
    * ```
    */
  get domainName(): Prisma.DomainNameDelegate<ExtArgs, { omit: OmitOpts }>;
   ...
   * `prisma.pomodoroSettings`: Exposes CRUD operations for the **PomodoroSettings** model.
    ...
    * ```
    */
  get pomodoroSettings(): Prisma.PomodoroSettingsDelegate<ExtArgs, { omit: OmitOpts }>;
   ...
   * `prisma.stickyNote`: Exposes CRUD operations for the **StickyNote** model.
    ...
    * ```
    */
  get stickyNote(): Prisma.StickyNoteDelegate<ExtArgs, { omit: OmitOpts }>;
