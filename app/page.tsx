  ...
  const tools = [
    {
      ...
      icon: <Images className="h-8 w-8" color="#00B5D4" />,
      available: true,
    ...
    },
    {
      ...
      icon: <Eraser className="h-8 w-8" color="#00B5D4" />,
      available: true,
      requiresApiKey: true,
    },
    {
      ...
      icon: <BookType className="h-8 w-8" color="#00B5D4" />,
      available: true,
      requiresApiKey: true,
    },
    {
      ...
      icon: <Sparkles className="h-8 w-8" color="#00B5D4" />,
      available: false,
      requiresApiKey: false,
    },
  ];
